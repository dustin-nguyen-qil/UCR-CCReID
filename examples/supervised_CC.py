...
def main_worker(args):
    ...
    # Create data loaders
    dataset_prcc = get_data('prcc', args.data_dir)
    dataset_ltcc = get_data('ltcc', args.data_dir)
    dataset_last = get_data('last', args.data_dir)

    dataset_real28 = get_data('real28', args.data_dir)
    dataset_vcclothes = get_data('vcclothes', args.data_dir)
    dataset_celeblight = get_data('celeblight', args.data_dir)
    dataset_deepchange = get_data('deepchange', args.data_dir)
    
    datasets = [dataset_prcc, dataset_ltcc, dataset_last]
    datasets_unseen = [dataset_real28, dataset_vcclothes, dataset_celeblight, dataset_deepchange]
    # Create model
